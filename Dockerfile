...
LABEL   author="Joerg Heinrich <joerg@jfheinrich.eu>" \
    ...
    license="MIT" \
    source="https://gitlab.com/jfheinrich-dev/pre-commit.git" \
    org.label-schema.vcs-url="https://gitlab.com/jfheinrich-dev/pre-commit.git" \
    ...
    org.opencontainer.image.source="https://gitlab.com/jfheinrich-dev/pre-commit.git" \
